...
<header class="hero">
  ...
  <div class="stats">
    <div class="stat"><div class="v">4.087</div><div class="k">telemetrili oyun</div></div>
...
<section>
  ...
  <h3 style="font-family:'Instrument Serif',Georgia,serif;font-weight:400;font-size:1.5rem;margin:3rem 0 .35rem">
    Ve eğri, aletin kendisini ölçüyormuş</h3>
